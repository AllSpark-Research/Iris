...
TASKS_PER_RUN = 900
DATA_PATH = str(
    Path(__file__).resolve().parents[2] / "data" / BENCHMARK_NAME / "standardized_data.jsonl"
)
# task ids are "deepsearchqa_<n>", not hex like the other benchmarks
TASK_ID_PATTERN = r"task_(deepsearchqa_\d+)"
